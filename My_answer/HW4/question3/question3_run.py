...
map_matrix = np.load('intelligent-robot-simulator/Homework/HW4/question3/map_matrix.npy')
reward_matrix = np.load('intelligent-robot-simulator/Homework/HW4/question3/reward_matrix.npy')
