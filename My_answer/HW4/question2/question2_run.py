...
map_matrix = np.load('intelligent-robot-simulator/Homework/HW4/question2/map_matrix.npy')
reward_matrix = np.load('intelligent-robot-simulator/Homework/HW4/question2/reward_matrix.npy')
